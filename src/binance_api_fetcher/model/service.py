...
class Service:
    ...
    #         self.increment_status_code(entity=entity, status_code=response.status_code)
    ...
    #     container_age = Gauge(
    #         "container_age", " Start time of the process since unix epoch in seconds."
    #     )
    ...
    #             counter.labels(
    #                 "binance-delivery-api", __version__, "analytics", "loaders", op
    #             )
    ...
    #             counter.labels(
    #                 "binance-delivery-api", __version__, "analytics", "loaders", code
    #             )
    ...
    #         counter.labels(
    #             "binance-delivery-api", __version__, "analytics", "loaders", "create"
    #         ).inc(amount=len(events[EventType.CREATE]))
    #         counter.labels(
    #             "binance-delivery-api", __version__, "analytics", "loaders", "amend"
    #         ).inc(amount=len(events[EventType.AMEND]))
    #         counter.labels(
    #             "binance-delivery-api", __version__, "analytics", "loaders", "remove"
    ...
    #     logger.info(f"Entity {entity}: prometheus status code counters incremented.")